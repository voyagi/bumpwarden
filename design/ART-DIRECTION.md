...
| Role                                                 | Face                                                                      | Why                                                                                                                                               |
| ---------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Display: page titles, lever plates, dependency names | **Archivo** (OFL, Omnibus Type), variable `wdth 62..125`, `wght 100..900` | Descends from the American grotesques cut for signage and newsprint. The width axis is what makes a cast plate read as stamped rather than typed. |
...
| Notices: the generated brief, quoted upstream text   | **Newsreader** (OFL, Production Type), `opsz 6..72`                       | The brief is somebody else's words pinned to a board. A book serif says that before you read a word of it.                                        |
