    ...
    <>
      ...
      <section class="wrap" style="margin-top:-30px">
        ...
        <div class="bands">
          ...
          <div class="card">
            <h3>Every brief says a model wrote it</h3>
            <p>
              A brief is text an AI model generated, and it is posted into a repository without a
              person reading it first. So every issue, pull request and comment that carries one
              says so in plain words, names the model, and asks the reader to read the brief before
